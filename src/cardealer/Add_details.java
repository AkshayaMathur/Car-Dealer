...
public class Add_details extends javax.swing.JFrame {
    ...
    String Car, FirstName, MiddleName, LastName, line;
    private void formWindowOpened(java.awt.event.WindowEvent evt) {                                  
        mod = (DefaultTableModel)Table.getModel();
        mod.addColumn("Car Name");
        mod.addColumn("Customer Name");
        mod.addColumn("Colour Of Car");
        mod.addColumn("Amount Paid");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {                                       
        ...
        String st[] = {Car, FirstName, MiddleName, LastName};
        mod.addRow(st);
        saveFile();
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {                                         
        new Add_details().setVisible(false);
        dispose();
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        Car = model.getValueAt(index, 0).toString();
